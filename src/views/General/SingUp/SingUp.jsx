...
export default function SingUp() {
    ...
    const checkoutSchema = yup.object().shape({
        AP: yup.string().required("requerido").min(3, `Ingresa Un Apellido Valido`).max(45, `Tu Apellido Es Demasiado Largo`),
        AM: yup.string().required("requerido").min(3, `Ingresa Un Apellido Valido`).max(45, `Tu Apellido Es Demasiado Largo`),
        Name: yup.string().required("requerido").min(3, `Ingresa Un Nombre Valido`).max(45, `Tu Nombre Es Demasiado Largo`),
        PW: yup.string().required("requerido").min(8, `Ingresa Una Contraseña mayor a 8 caracteres valida`).max(500, `Tu Contraseña Es Demasiada Larga`),
        AE: yup.string().required("requerido").email(`Ingresa Un Correo Electronico Valido`).max(100, `Tu Dirección Es Demasiada Larga`),
    });
                                                ...
                                                <Form onSubmit={handleSubmit}>
                                                    <div className="form-row mb-2">
                                                        <div className="form-group col-md-6">
                                                            ...
                                                            <TextField type="text" className="form-control" placeholder="Tu Apellido Paterno" id="AP" name="AP" required onChange={handleChange} onBlur={handleBlur} error={!!touched.AP && !!errors.AP} helperText={touched.AP && errors.AP}/>
                                                        </div>
                                                        <div className="form-group col-md-6">
                                                            <label className="font-weight-bold">Apellido Materno <span className="text-danger">*</span></label>
                                                            <TextField type="text" className="form-control" placeholder="Tu Apellido Materno" id="AM" name="AM" required onChange={handleChange} onBlur={handleBlur} error={!!touched.AM && !!errors.AM} helperText={touched.AM && errors.AM} />
                                                        </div>
                                                    </div>
                                                    <div className="form-group mb-3">
                                                        <label className="font-weight-bold">Nombre(s)<span
                                                            className="text-danger">*</span></label>
                                                        <TextField type="text" className="form-control" placeholder="Ingresa tu(s) nombre(s)" id="Name" name="Name" required onChange={handleChange} onBlur={handleBlur} error={!!touched.Name && !!errors.Name} helperText={touched.Name && errors.Name} />
                                                    </div>
                                                    <div className="form-group mb-3">
                                                        <label className="font-weight-bold">Email <span className="text-danger">*</span></label>
                                                        <TextField type="email" className="form-control" placeholder="Ingresa tu correo Electronico" id="AE" name="AE" required onChange={handleChange} onBlur={handleBlur} error={!!touched.AE && !!errors.AE} helperText={touched.AE && errors.AE} />
                                                    </div>
                                                    <div className="form-group mb-3">
                                                        <label className="font-weight-bold">Contraseña <span className="text-danger">*</span></label>
                                                        <TextField type="password" className="form-control" placeholder="Ingresa una contraseña" id="PW" name="PW" required onChange={handleChange} onBlur={handleBlur} error={!!touched.PW && !!errors.PW} helperText={touched.PW && errors.PW} />
                                                    </div>
