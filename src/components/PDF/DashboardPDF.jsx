...
const DocuPDF = (results) => {
  const res = results.results.results;
  console.log(res);
      ...
      <Page
        ...
        <View
          ...
          <View
            ...
            <Text style={{ color: "#01a7c2", fontSize: "42px" }}>Factura</Text>
          ...
          <View
            ...
            <Text
              style={{ color: "black", fontSize: "14px", paddingBottom: 5 }}>
              GESTICK
            </Text>
            <Text
              style={{ color: "black", fontSize: "14px", paddingBottom: 5 }}>
              gestick@gesticksa.com
            </Text>
            <Text
              style={{ color: "black", fontSize: "14px", paddingBottom: 5 }}>
              91-1234-567
          ...
          <View
            ...
            <View
              ...
              <Text
                style={{ color: "black", fontSize: "10px", paddingBottom: 5 }}>
                Destinatario de la factura que la pidio
              </Text>
              <Text
                style={{ color: "black", fontSize: "10px", paddingBottom: 5 }}>
                Direccion del destinatario de la factura que se pidio
              </Text>
            </View>
            ...
            <View
              ...
              <Text
                style={{ color: "black", fontSize: "10px", paddingBottom: 5 }}>
                Destinatario de la factura indicarlos en esta parte
              </Text>
              <Text
                style={{ color: "black", fontSize: "10px", paddingBottom: 5 }}>
                Direccion a la que se entregaran los productos en esta parte
              </Text>
            </View>
            ...
            <View
              ...
              <View
                ...
                <Text
                  ...
                  {results.dia}/{results.mes}/{results.anno}
                </Text>
                <Text
                  style={{
                    color: "black",
        ...
        <View
          ...
          <View
            ...
            <Text style={{ color: "gray", fontSize: "10px", paddingBottom: 5 }}>
              El pago se realizará en un plazo de 15 dias desde la emisión de
              esta factura, se realizará mediante transferencia bancaria.
            </Text>
          </View>
        </View>
      </Page>
